...
contract Vault {
    ...
    // slot 1
    address public owner = msg.sender; //22
    ...
    function addUser(bytes32 _password, uint256 _id) public {
...
result_4 = await ethers.provider.getStorageAt("0xcf7ed3acca5a467e9e704c703e8d87f634fb0fc9", 2)
web3.utils.hexToString("0x70617373776f7264313233000000000000000000000000000000000000000000")
*/
